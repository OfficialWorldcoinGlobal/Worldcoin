...
# TestP2PConn: A peer we use to send messages to worldcoind, and store responses.
...
class CompactBlocksTest(WorldcoinTestFramework):
    ...
    # This test actually causes worldcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that worldcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for worldcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # worldcoind will not send blocktxn responses for blocks whose height is
