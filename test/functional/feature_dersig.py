...
class BIP66Test(WorldcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # worldcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and worldcoind produces more specific reject
            # reasons.
