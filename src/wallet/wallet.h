...
#ifndef WORLDCOIN_WALLET_WALLET_H
#define WORLDCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this worldcoin node, and set to 0 for transactions that were created
...
#endif // WORLDCOIN_WALLET_WALLET_H
