...
#ifndef WORLDCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define WORLDCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // WORLDCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
