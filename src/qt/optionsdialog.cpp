    ...
    mapper(0)
{
    ...
    ui->worldcoinAtStartup->setToolTip(ui->worldcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->worldcoinAtStartup->setText(ui->worldcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openWorldcoinConfButton->setToolTip(ui->openWorldcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
...
void OptionsDialog::on_openWorldcoinConfButton_clicked()
{
