...
BOOST_AUTO_TEST_CASE(subsidy_limit_test)
{
    ...
    for (nHeight = 0; nHeight <= 100000; nHeight++) {
        CAmount nSubsidy = GetWorldcoinBlockSubsidy(nHeight, params);
    ...
    CAmount nConstantSubsidy = GetWorldcoinBlockSubsidy(600000, params);
    BOOST_CHECK_EQUAL(nConstantSubsidy, 10000 * COIN);

    nConstantSubsidy = GetWorldcoinBlockSubsidy(700000, params);
    BOOST_CHECK_EQUAL(nConstantSubsidy, 10000 * COIN);
}
