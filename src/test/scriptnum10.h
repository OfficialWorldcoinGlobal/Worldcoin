...
#ifndef WORLDCOIN_TEST_SCRIPTNUM10_H
#define WORLDCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Worldcoin Core 0.10.0, for cross-comparison.
 */
public:
