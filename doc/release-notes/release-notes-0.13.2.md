Worldcoin Core version 0.13.2 is now available from:
  ...
  <https://worldcoin.org/bin/worldcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update worldcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow worldcoin-tx to create v2 transactions (eacdrak)
