Worldcoin Core version *0.15.0.1* is now available from:

  <https://worldcoin.org/bin/worldcoin-core-0.15.0.1/>

and

  <https://worldcoincore.org/bin/worldcoin-core-0.15.0.1/>
