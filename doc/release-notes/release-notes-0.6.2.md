Worldcoin version 0.6.2 is now available for download at:
http://sourceforge.net/projects/worldcoin/files/Worldcoin/worldcoin-0.6.2/
...
Fixed https://github.com/worldcoin/worldcoin/issues/1065, a bug that
