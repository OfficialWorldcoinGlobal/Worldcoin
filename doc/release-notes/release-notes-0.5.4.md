Worldcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/worldcoin/files/Worldcoin/worldcoin-0.5.4/
...
http://gitorious.org/worldcoin/worldcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Worldcoin-Qt notifications under Growl 1.3.
Increase required age of Worldcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxWorldcoin properly when installing Worldcoin-Qt over it. (Windows)
