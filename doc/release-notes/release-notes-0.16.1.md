Worldcoin Core version 0.16.1 is now available from:

  <https://worldcoincore.org/bin/worldcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting worldcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure worldcoind processes are cleaned up when tests end (sdaftuar)
