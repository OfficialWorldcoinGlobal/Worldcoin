Worldcoin Core version 0.14.1 is now available from:

  <https://worldcoin.org/bin/worldcoin-core-0.14.1/>
...
here:
[reducing-worldcoind-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` worldcoin-tx input verification (awemany, jnewbery)
