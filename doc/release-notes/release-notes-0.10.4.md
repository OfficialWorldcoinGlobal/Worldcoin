Worldcoin Core version 0.10.4 is now available from:

  <https://worldcoin.org/bin/worldcoin-core-0.10.4/>
...
- #6953 `43c2789` Split worldcoin-tx into its own package
- #6953 `dfe0d4d` Include worldcoin-tx binary on Debian/Ubuntu
