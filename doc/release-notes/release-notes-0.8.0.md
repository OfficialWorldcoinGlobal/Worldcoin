Worldcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/worldcoin/files/Worldcoin/worldcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Worldcoin
...
New/changed settings (command-line or worldcoin.conf file)
--------------------------------------------------------
