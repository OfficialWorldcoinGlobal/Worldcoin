Worldcoin Core version 0.9.4 is now available from:

  https://worldcoin.org/bin/0.9.4/
...
this update is incompatible with the Worldcoin system and could lead to consensus
forks.

Worldcoin Core released binaries from https://worldcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~worldcoin/+archive/ubuntu/worldcoin
- A third-party or self-compiled Worldcoin Core

upgrade to Worldcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
