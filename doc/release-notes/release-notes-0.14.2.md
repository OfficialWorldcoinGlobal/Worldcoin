Worldcoin Core version 0.14.2 is now available from:
  ...
  <https://worldcoin.org/bin/worldcoin-core-0.14.2/>
...
(in Worldcoin Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Worldcoin-Qt when using coin
...
- #10228 `ae479bc` Regenerate worldcoin-config.h as necessary (theuni)
